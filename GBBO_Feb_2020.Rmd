...
These functions are some of the most frequently used, but obviously not the only ones. "dplyr" is part of the "tidyverse", which is huge collection of packages.

https://ukdataservice.ac.uk/media/622519/slides.pdf
